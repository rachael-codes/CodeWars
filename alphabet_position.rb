...
# Algo
# -initialize an array that contains every alphabet letter 
# -convert every letter in the string to downcase and split the input string into an array
# -iterate over array and substitute each letter with the equivalent in the array 
# -delete excessive spaces from array then rejoin it into a string 
